          ...
          <div className="space-y-12">
            ...
            <section>
              ...
              <p className="leading-relaxed">
                By accessing or using the services provided by Dentrix Apps LLC,
                a limited liability company registered in the State of Wyoming,
                United States (&quot;we,&quot; &quot;us,&quot; or
            ...
            <section>
              <h2 className="text-xl font-bold text-[oklch(1_0_0)] mb-4 flex items-center gap-2">
                <span className="text-[oklch(0.85_0.3_150)]">[02]</span>{" "}
                Intellectual Property
              </h2>
              ...
              <ul className="list-none space-y-4 ml-4">
                <li className="flex gap-3">
                  ...
                  <span>
                    <strong>Work Product Appearance:</strong> All unique
                    deliverables, custom software, and designs specifically
                    developed for a client are assigned to said client upon full
                    and final payment.
                  </span>
                </li>
                <li className="flex gap-3">
                  <span className="text-[oklch(0.85_0.3_150)]">/</span>
                  <span>
                    <strong>Retained Rights:</strong> Dentrix Apps retains all
                    rights to its proprietary frameworks, base code libraries,
                    and general methodologies used to create the deliverables.
                  </span>
                </li>
                <li className="flex gap-3">
                  <span className="text-[oklch(0.85_0.3_150)]">/</span>
                  <span>
                    <strong>Trademarks:</strong> All trademarks, logos, and
                    service marks displayed on the site are our property or the
                    property of other third parties.
                  </span>
                </li>
              </ul>
            </section>
            ...
            <section>
              <h2 className="text-xl font-bold text-[oklch(1_0_0)] mb-4 flex items-center gap-2">
                <span className="text-[oklch(0.85_0.3_150)]">[03]</span>{" "}
                Liability Constraint
              </h2>
              <p className="leading-relaxed mb-4">
                To the maximum extent permitted by applicable law, Dentrix Apps
                shall not be liable for any indirect, incidental, special,
                consequential, or punitive damages, or any loss of profits or
                revenues, whether incurred directly or indirectly.
              </p>
              <div className="bg-white/5 border-l-2 border-[oklch(0.85_0.3_150)] p-4 text-sm italic">
                &quot;Our maximum aggregate liability for any claim arising out
                of or relating to these terms or our services shall not exceed
                the total amount paid by you to us in the six (6) months
                preceding the claim.&quot;
              </div>
            </section>
            ...
            <section>
              <h2 className="text-xl font-bold text-[oklch(1_0_0)] mb-4 flex items-center gap-2">
                <span className="text-[oklch(0.85_0.3_150)]">[04]</span>{" "}
                Governing Law
              </h2>
              <p className="leading-relaxed">
                These Terms and any action related thereto will be governed by
                the laws of the <strong>State of Wyoming</strong> (United
                States) without regard to its conflict of laws provisions. Any
                legal action or proceeding arising under these Terms will be
                brought exclusively in the courts located in Wyoming. Dentrix
                Apps LLC is registered and operated in the State of Wyoming,
                United States.
              </p>
            </section>
            ...
            <section>
              <h2 className="text-xl font-bold text-[oklch(1_0_0)] mb-4 flex items-center gap-2">
                <span className="text-[oklch(0.85_0.3_150)]">[05]</span>{" "}
                Termination
              </h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-[oklch(1_0_0)] mb-4 flex items-center gap-2">
                <span className="text-[oklch(0.85_0.3_150)]">[06]</span>{" "}
                Protocol Updates
              </h2>
              <p className="leading-relaxed">
