...
export function ContactSection() {
  ...
  const whatsappMethod = contactMethods.find(m => m.type === "whatsapp");
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8">
          ...
          >
            ...
            <p className="text-sm text-white/30 mb-6">Tell us what you need and we'll respond within 1 hour.</p>
              ...
              <form ref={formRef} action={formAction} className="space-y-4" noValidate>
                ...
                <div className="space-y-1">
                  ...
                  <textarea required id="description" name="description" rows={4} maxLength={MAX_MESSAGE + 500}
                    ...
                    placeholder="Describe your project: what voice you need, script length, language, timeline..."
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {calendlyMethod && (
                <a href="https://calendly.com/dentrixapps/discovery" target="_blank" rel="noreferrer"
              ...
              {whatsappMethod && (
                <a href={`https://wa.me/${whatsappMethod.label.replace(/\D/g, "")}`} target="_blank" rel="noreferrer"
                  className="p-5 rounded-xl border border-white/5 bg-white/5 hover:bg-white/[0.07] transition-colors group flex flex-col gap-2"
                >
                  <MessageCircle className="w-5 h-5 text-white/25" />
                  <div>
                    <p className="text-sm font-bold text-white/70 group-hover:text-[oklch(0.85_0.3_150)] transition-colors">
                      {whatsappMethod.label}
                    </p>
                    <p className="text-xs text-white/25 mt-1 font-mono">Quick response on WhatsApp</p>
                  </div>
                </a>
              )}
            </div>
